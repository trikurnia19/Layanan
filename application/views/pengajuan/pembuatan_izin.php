...
<form action="<?php echo base_url() . 'lampiran/add_perizinan'; ?>" method="post" enctype="multipart/form-data">
	<div class="row text-left">
		<div class="col-lg-12">
			<div class="block-heading">
				<h2>FORM PENGAJUAN PEMBUATAN PERIZINAN</h2>
			</div>
			<!-- Isian Form 1-->
        ...
        <div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
                ...
                <div class="form-group">
					...
					<input type="file" class="form-control" name="fcnpwp" id="fcnpwp" required>
				</div>

                <div class="form-group">
					<label>AJB/Berkas Kepemilikan</label>
					<input type="file" class="form-control" name="ajb" id="ajb" required>
				</div>
