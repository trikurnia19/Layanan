...
<form action="<?php echo base_url() . 'lampiran/add_pembaruankk'; ?>" method="post" enctype="multipart/form-data">
	<div class="row text-left">
		<div class="col-lg-12">
			<div class="block-heading">
				<h2>FORM PENGAJUAN PEMBARUAN KARTU KELUARGA</h2>
			</div>
			<!-- Isian Form 1-->
        ...
        <div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
                ...
                <div class="form-group">
					<label>Kartu Keluarga Asli</label>
