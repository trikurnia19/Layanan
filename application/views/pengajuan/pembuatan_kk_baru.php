...
<form action="<?php echo base_url() . 'lampiran/add_kkbaru'; ?>" method="post" enctype="multipart/form-data">
	<div class="row text-left">
		<div class="col-lg-12">
			<div class="block-heading">
				<h2>FORM PENGAJUAN PEMBUATAN KARTU KELUARGA</h2>
			</div>
			<!-- Isian Form 1-->
			<div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
				...
				<div class="form-group">
					<label>Alamat</label>
					<textarea class="form-control" name="alamat" id="alamat" rows="2" value="<?= $user['alamat']; ?>" required></textarea>
				</div>
				<div class="form-group">
        ...
        <div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
				<p class="text-left" style="font-size: 25px;">Form 2 Lampiran</p>
				<hr>
        
                <div class="form-group">
					<label>Foto Copy KTP</label>
					<input type="file" class="form-control" name="fcktp" id="fcktp" required>
				</div>

                <div class="form-group">
					<label>Foto Copy Kartu Keluarga</label>
					<input type="file" class="form-control" name="fckk" id="fckk" required>
				</div>

                <div class="form-group">
					<label>Foto Copy Buku Nikah</label>
					<input type="file" class="form-control" name="fcbn" id="fcbn" required>
				</div>

                <div class="form-group">
					<label>Surat Pindah</label>
					<input type="file" class="form-control" name="sp" id="sp"required>
				</div>

                <div class="form-group">
					<label>Pengantar Rt / Rw</label>
					<input type="file" class="form-control" name="pengantarrt" id="pengantarrt" required>
				</div>

                <div class="form-group">
					<label>Foto Copy Ijazah</label>
					<input type="file" class="form-control" name="fcijazah" id="fcijazah" required>
				</div>

                <div class="form-group">
					<label>Foto Copy Akta Lahir</label>
					<input type="file" class="form-control" name="fcakta" id="fcakta" required>
				</div>
