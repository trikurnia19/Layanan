...
<form action="<?php echo base_url() . 'lampiran/add_pembuatanakta'; ?>" method="post" enctype="multipart/form-data">
	<div class="row text-left">
		<div class="col-lg-12">
			<div class="block-heading">
				<h2>FORM PENGAJUAN PEMBUATAN AKTA KELAHIRAN</h2>
			</div>
			<!-- Isian Form 1-->
