...
<form action="<?php echo base_url() . 'Surat/add_sk_usaha'; ?>" method="post">
	<div class="row text-left">
		<div class="col-lg-12">
			...
			<div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
				<p class="text-left" style="font-size: 25px;">Form 2 Data Usaha</p>
				<hr>
				<div class="form-row">
					<div class="form-group col-md-6">
						<label>Nama Usaha</label>
						<input id="nama_usaha" name="nama_usaha" class="form-control" placeholder="Masukan Nama Usaha" required>
					</div>
					<div class="form-group col-md-6">
						<label>Penghasilan Per Bulan</label>
						<input id="penghasilan" name="penghasilan" class="form-control" placeholder="Rp." value="<?='Rp.' ?>" required>
					</div>
				</div>
				
				<div class="form-group">
						<label>Alamat Usaha</label>
						<input id="alamat_usaha" name="alamat_usaha" class="form-control" row="2" placeholder="Masukan Alamat Usaha" required>
					</div>
