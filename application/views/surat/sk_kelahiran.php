...
<form action="<?php echo base_url() . 'Surat/add_sk_kelahiran'; ?>" method="post" enctype="multipart/form-data">
	<div class="row text-left">
		<div class="col-lg-12">
            ...
            <div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
				<p class="text-left" style="font-size: 25px;">Form 2 Data Anak</p>
				<hr>
    
				<div class="form-row">
					<div class="form-group col-md-6">
						<label>Nama</label>
						<input type="text" name="nama_anak" class="form-control" id="nama_anak" placeholder="Masukan Nama Anak " required>
					</div>
					<div class="form-group col-md-3">
						<label>Hari Kelahiran</label>
						<select name="hari_lahir" id="hari_lahir"  class="form-control" required>
                    ...
                    <div class="form-group col-md-3">
						<label>Jenis Kelamin</label>
						<select name="jenis_kelamin_anak" id="jenis_kelamin_anak" class="form-control">
							<option selected>Laki - Laki</option>
							<option>Perempuan</option>
						</select>
					</div>
                ...
                <div class="form-row">
					<div class="form-group col-md-6">
						<label>Tempat Lahir</label>
						<input type="text" name="tempat_lahir_anak" class="form-control" id="tempat_lahir" placeholder="Masukan Tempat Lahir " required>
					</div>
					<div class="form-group col-md-3">
						<label>Tanggal Lahir</label>
						<input type="date" name="tanggal_lahir_anak" class="form-control" id="tgl_anak" required>
					</div>
					<div class="form-group col-md-3">
						<label>Waktu Lahir</label>
						<input name="waktu_lahir" id="waktu_lahir" placeholder="00.00 WIB " class="form-control" required>
					</div>
				</div>
                ...
                <div class="form-row">
					<div class="form-group col-md-6">
						...
						<input type="text" name="berat_anak" class="form-control" id="berat_anak" placeholder="Kg " required>
					</div>
					<div class="form-group col-md-3">
						<label>Panjang</label>
						<input type="text" name="panjang_anak" class="form-control" id="panjang_anak" placeholder="Cm" required>
					</div>
					<div class="form-group col-md-3">
						<label>Anak Ke -</label>
						<input type="text" name="anak_ke" id="anak_ke" placeholder="Anak Ke - " class="form-control" required>
					</div>
				</div>
                ...
                <div class="form-row">
					<div class="form-group col-md-6">
						...
						<input id="nama_ayah" name="nama_ayah" placeholder="Masukan Nama Ayah " class="form-control" required>
					</div>
					<div class="form-group col-md-6">
						<label>Umur Ayah</label>
						<input id="umur_ayah" name="umur_ayah" placeholder="Masukan Umur Ayah "class="form-control"  required>
					</div>
				</div>
                ...
                <div class="form-row">
					<div class="form-group col-md-6">
						...
						<input id="nama_ibu" name="nama_ibu" placeholder="Masukan Nama Ibu " class="form-control" required>
					</div>
					<div class="form-group col-md-6">
						<label>Umur ibu</label>
						<input id="umur_ibu" name="umur_ibu" placeholder="Masukan Umur Ibu " class="form-control"  required>
					</div>
				</div>
            ...
            <div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
				<p class="text-left" style="font-size: 25px;">Form 3 Lampiran</p>
				<hr>

                <!-- <div class="form-group">
					<label>Surat Ket Lahir Bidan / Dokter</label>
					<input type="file" class="form-control" name="sklahir" id="sklahir" required>
				</div> -->
